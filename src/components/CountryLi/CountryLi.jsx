...
export const CountryLi = ()=>{
    ...
    return(
        <>
        {filteredCountries && filteredCountries.length == 0 && <li className='Empty-li'>No results... Try again!</li>}
        {filteredCountries && filteredCountries.length != 0 && filteredCountries.map( eachCountry => 
